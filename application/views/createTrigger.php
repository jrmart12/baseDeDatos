...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <a class="navbar-brand" href="#">Create Trigger</a>
  ...
  <div class="container">
      <?php echo form_open("welcome/createTrigger", ['class'=>'form-horizontal']);?>
  <fieldset>
...
<?php echo form_close();?>
  ...
  <legend>DDL</legend>
<div>
<?php echo "CREATE TRIGGER ".$this->input->post('title')." ON [dbo].[".$this->input->post('description2')."]".$this->input->post('description1')." AS". $this->input->post('description')."";?>
</div>
