...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <a class="navbar-brand" href="#">Create Function</a>
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarColor02" aria-controls="navbarColor02" aria-expanded="false" aria-label="Toggle navigation" style="">
	...
	<div class="container">
			<?php echo form_open("welcome/createFunction", ['class'=>'form-horizontal']);?>
  <fieldset>
...
<?php echo form_close();?>
  ...
  <legend>DDL</legend>
<div>
<?php echo "create Function [dbo].[".$this->input->post('title')."]()returns ".$this->input->post('description1')." as begin ".$this->input->post('description')."end";?>
</div>
