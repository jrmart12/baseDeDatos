...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <a class="navbar-brand" href="#">Create Procedure</a>
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarColor02" aria-controls="navbarColor02" aria-expanded="false" aria-label="Toggle navigation" style="">
	...
	<div class="container">
			<?php echo form_open("welcome/createProcedure", ['class'=>'form-horizontal']);?>
  <fieldset>
...
<?php echo form_close();?>
  ...
  <legend>DDL</legend>
<div>
<?php echo "CREATE PROCEDURE dbo.".$this->input->post('title')." AS ".$this->input->post('description')."";?>
  </div>
