...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <a class="navbar-brand" href="#">Create Primary Key</a>
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarColor02" aria-controls="navbarColor02" aria-expanded="false" aria-label="Toggle navigation" style="">
	...
	<div class="container">
			<?php echo form_open("welcome/createPK", ['class'=>'form-horizontal']);?>
  <fieldset>
    <legend>Create PrimaryKey</legend>
...
<?php echo form_close();?>
  ...
  <legend>DDL</legend>
<div>
<?php echo "ALTER TABLE ".$this->input->post('title')."ADD CONSTRAINT ".$this->input->post('description')." PRIMARY KEY (".$this->input->post('description1').");";?>
  </div>
